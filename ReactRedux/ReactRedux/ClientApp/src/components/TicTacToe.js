    ...
    TicTacToeBoard.prototype.renderSquares = function () {
        ...
        for (var r = 0; r < n; ++r) {
            ...
            var _loop_1 = function (c) {
                var idx = r * n + c;
                cols.push(React.createElement("button", { id: idx.toString(), onClick: function () { _this.props.check(idx); }, className: cssClass }, this_1.props.squares[idx]));
            };
            var this_1 = this;
            for (var c = 0; c < n; ++c) {
                _loop_1(c);
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("br", null),
            React.createElement("div", null,
                React.createElement("button", { className: "reset", onClick: function () { _this.props.reset(); } }, "Reset"))));
    };
